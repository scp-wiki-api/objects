...
Thereafter, an exponentially increasing number of ants will appear on the exposed subject by day. Throughout the entire day, the number of ants that appear seems to be in the range of 3^^X^^ to 5^^X^^, where X is the number of days since initial contact with SCP-302. As time progresses, the ants not only increase in number, but also change in species. Smaller, minimally harmful species appear at first, later transitioning to larger species, or species with more painful stings or bites.
