...
SCP-440 is capable of giving this property to other samples of sand, essentially transforming it into SCP-440 itself Sands with a particle size of >1mm do not gain this ability. . The process governing this conversion is believed to be based on contact, requiring SCP-440 to be introduced into a sample of unconverted sand via compressed air. The rate of conversion from basic sand to SCP-440 is also unknown, but it is understood that approximately 30% (by mass) of 'seed sand' does not convert.
