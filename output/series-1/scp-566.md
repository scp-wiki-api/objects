...
| --- | --- | --- | --- |
| Definition of mundane words or idioms coined post publication date | 3% | **sofalizing** (n) | Using the Internet or other electronic devices to socialize with people from home, rather than meeting them face to face.First public mentions of word appear in 2010. |
...
| Definitions of words or idioms referring to classified subjects or events | <1% | **to brundle about** (v) | To show markedly less activity than doing nothing, after Brundle, a pet mass of cellular matter of Dr.  ██████ Information appears in the classified [SCP-726](SCP-726) file. |
