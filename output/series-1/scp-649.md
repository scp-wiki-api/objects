...
Whenever a match from SCP-649 is struck, snowflakes will shoot out in contrast to the sparks of a normal match.Note: striking a match does not light, consume, or alter it. Once struck, the head will show visible crystallization and the main anomalous properties of SCP-649 will manifest; this can also be achieved by leaving SCP-649 open for more than fifteen minutes.
...
Dr. Pena began sampling the precipitation and soil.Analysis showed that these had no anomalous properties. During this she reported the feeling of being stared at.
...
> **Source Link:** [pxhere](https://pxhere.com/en/photo/553942)
