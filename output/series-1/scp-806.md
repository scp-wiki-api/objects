...
When active, SCP-806 creates biological material through an unknown process, which arranges itself in a manner that recreates a nude “copy” of a deceased subject in the open space before the screen, as they were at the time of the latest recording used. Note that fictional characters depicted are not restored; only the actor of that character will be recreated.The target appears random, favouring whichever figure has the most on-screen time.Cartoon films have no effect within SCP-806.
...
If the projector is shut down, the instance of SCP-806-1 will fail, usually dissolving into a mixture of blood and graphite dust.  Two tests wherein the process was intentionally interrupted at the 19th hour led to ‘unfinished’ physical bodies collapsing onto the floor; the more-formed instance succumbed to brain death, where the less complete instance simply died.
