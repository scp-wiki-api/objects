...
* To be addressed by a two-syllable name that has been transliterated as “Aé”, SCP-811 being illiterate, and thus not capable of choosing a spelling for itself (approved) Due to SCP-811's difficulty with language, it has been deemed acceptable to use its chosen name when directly speaking to it for the purpose of streamlining meaningful communication.
