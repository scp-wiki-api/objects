...
Check out our other article: [SCP-8020](https://scp-wiki.wikidot.com/scp-8020)
...
    --basalt-secondary-color: 12, 12, 12;

    --basalt-tertiary-color: 20, 20, 20;

    --basalt-main-text-color: 180, 180, 180;

    --general-border-color: 25, 25, 25;

    --glass-color: 0, 0, 0;

    --swatch-menubg-black-color: 25, 25, 25;

    --swatch-menubg-dark-color: 66, 66, 66;

    --swatch-menutxt-dark-color: 50, 50, 50;

    --basalt-UI-blur: 0.08rem;

    --basalt-UI-opacity: 0.5;
...
    ~~header-logo: url("https://scp-wiki.wdfiles.com/local~~files/scp-8020/site03.png");
...
        linear-gradient(to right, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.4)),
...
        linear-gradient(rgba(150,150,150,.04) 1px, transparent 1px),

        linear-gradient(transparent 3px, rgb(11, 11, 11) 3px, rgb(11, 11, 11) 78px, transparent 78px),

        linear-gradient(-90deg, #2a2a2a 1px, transparent 1px),

        linear-gradient(-90deg, transparent 3px, rgb(11, 11, 11) 3px, rgb(11, 11, 11) 78px, transparent 78px),
...
    background-color: rgb(var(--glass-color, 66, 66, 72), 0.15);
...
    background: URL('https://scp-sandbox-3.wdfiles.com/local--files/anakes/scp_logo.png');
...
    background-image: url('https://scp-sandbox-3.wdfiles.com/local--files/anakes2/man.png');
...
 border: solid 2px rgb(var(--general-border-color));
...
  background-image: url('https://scp-sandbox-3.wdfiles.com/local--files/anakes2/test7b.png');
...
    background-color: rgb(var(--glass-color), 0);    
...
SCP-9050 is the designation given to a colossal thoughtform believed to be the source of all anomalous activity in the present day. Similar to more thoroughly researched entities of the same classThoughtforms are believed to be incredibly common, forming a fundamental layer of reality's informational substrate., SCP-9050 is an abstract, non-physical construct, given coherence through repetitive patterns of human thought and perception.

Despite most thoughtforms being extremely short-livedThis phenomenon is most evident in children who, singlehandedly, are capable of conjuring transient, low-complexity ‘friends’ from nothing but imagination and insistence., SCP-9050 predates recorded history and is hypothesized to coincide with the emergence of symbolic thought in early humans. Despite long-term changes in human society, SCP-9050 achieves persistent continuity through recurring motifs present in stories, artistic works, and theological frameworks spanning thousands of years, such as:
...
<< [SCP-9049](SCP-9049) | **SCP-9050** | [SCP-9051](SCP-9051) >>
...
> **Source Link:** [> **Filename:** 9k.png

> **Author:** Wereldmuseum Amsterdam

> **License:** CC BY-SA 3.0

> **Source Link:** https://commons.wikimedia.org/wiki/File:COLLECTIE_TROPENMUSEUM_De_constructiewerkplaats_in_de_fabriek_van_de_Nederlandsch_Indische_Industrie_te_Soerabaja_TMnr_60008598.jpg#mw-jump-to-license
...
> **Source Link:** <https://commons.wikimedia.org/wiki/File:Noun-crown-1045791.png](https://scp-sandbox-3.wdfiles.com/local--files/anakes/schema.png>)
