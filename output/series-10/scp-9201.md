...
* ![](https:*scp-wiki.wdfiles.com/local--files/scp-9201/atomicity.svg) **Atomicity:** All changes to the database take place within *transactions//. A transaction must succeed completely or not at all. If it fails, it must be entirely rolled back. It must not be possible for the system to write incomplete data.

* ![](https:*scp-wiki.wdfiles.com/local--files/scp-9201/consistency.svg) **Consistency:** All data must obey the constraints and restrictions described by the database's schema. For instance, if a field is marked as *unique//, no two items may have the same value for that field.

* ![](https://scp-wiki.wdfiles.com/local--files/scp-9201/isolation.svg) **Isolation:** The system must be able to handle many transactions occurring at the same time. Uncommitted transaction effects must not be "visible" to other operations occurring within the database.

* ![](https:*scp-wiki.wdfiles.com/local--files/scp-9201/durability.svg) **Durability:** Once a transaction has been successfully written, the data must be *durable//. At that point, even a system crash should not prevent data from being recoverable.
...
Installation and management of SCP-9201-B units is overseen by the [ RAISA Records & Archival Office](secure-facility-dossier-site-7 ).
...
<details>
<summary>+ INFORMATION RESTRICTED TO CLEARANCE LEVEL 5/9201</summary>

SCP-9201-B is the Foundation Global Anomaly Analyzer (FGAA). Its effective range is not known to be limited.
...
To date, SCP-9201-B has successfully reverted 807 K-class events and 525,931,281 severe containment breaches.

</details>

---

<< [SCP-9200](SCP-9200) | SCP-9201 | [SCP-9202](SCP-9202) >>
