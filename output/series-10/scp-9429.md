...
  --header-title: "R\0026 C SITE-41";

  --header-subtitle: "There Is No Antimemetics Division";

}

div#extra-div-1 {

    background-image: url(https://scp-wiki.wdfiles.com/local--files/secure-facilities-locations/Site-41.svg);
...
**Special Containment Procedures:** Physical containment of SCP-9429 is impractical due to its ##141414|size, and unnecessary due to its antimemetic effect. A## ##282828|secure perimeter has been established around the structure by the staff## ##3C3C3C|of Site-41, where exploration and study ofthe object can be safely conducted. Additional## ##505050|measures to secure the object from public knowledge have been deemed unnecessary due to the aforementioned self-concealing anomalous property##.

##646464|To prevent the expiration of memories regarding SCP-9429 impeding research, several## ##787878|miniature outposts and base camps equipped with rudimentary scientific equipment have been established across the structure's## ##8C8C8C|major plateaus so as to allow explorers to conduct study on details## ##A0A0A0|they observe while traversing it without leaving its premises##.

##B4B4B4|**Description:** SCP-9429 is a colossal (91-by-91-by-147-meter) basalt cuboid structure, presumably man-made in origin,## ##C8C8C8|situated in the forests of Lake County, Colorado, on the outskirts of Antimemetics R&C Site-41. The object is## ##DCDCDC|shaped to impressive geometric precision even by the standards of modern tools, indicating a sophisticated and deliberate construction. It superficially## ##F0F0F0|resembles a monolith or monument and features a variety of carved grooves, stairways, ramps, alcoves, "checkpoints", and other features across its## ##FFFFFF|surface usable to scale the object on-foot, seemingly implying the intention of continued occupation or visitation.##

@@ @@

**[FURTHER CONTENT ELAPSED...]**

@@ @@

@@ @@

Notice: You are currently viewing the latest iteration (10/02/2015) of this document. To view previous revisions, see below.
...
<details>
<summary>+ Show Rev. 034 (7/12/1977)</summary>
...
<details>
<summary>+ Show Rev. 057 (10/28/1978) (Excerpted)</summary>

@@ @@

You have enabled iterative viewing. Revisions to text made since the last viewed file iteration are noted in **##blue|blue##** for archival ease of use.
...
In April 1977, Dir. Marness ordered the transfer of several Antimemetics Division personnel to Provisional Area-41 to work on Project OBSCURUM##blue|, including spatial and perceptive containment researcher Bartholomew Hughes,## [from Site-19](https://scp-wiki.wikidot.com/scp-055)##blue|, whom Dir. Marness personally placed in charge of SCP-9429 research come July 1978.##
...
<details>
<summary>+ Show excerpted selections from Project OBSCURUM</summary>
...
![](https://upload.wikimedia.org/wikipedia/commons/a/ac/Willow_Peak_volcanic_cone.JPG)
...
Codes are ubiquitous in memetics, of course. This is because it's full of ideas which, to borrow a term from Heinlein, we can't quite *grok* with our feeble minds alone. We use code languages to transcribe memes which are too complex, or encrypt ones too dangerous. Hell, in some parts of Europe ~~ and Canada, of all places ~~ where the memetic tradition grew from slightly [https:*scp-wiki.wikidot.com/scp-5382 different roots] than in the States, you'll sometimes hear people call the field by another, more old-fashioned name: *cryptomancy//. Literally the art and science of making and breaking magical codes which unlock the mind.
...
We're under a high mnestic dose now, so I have to transcribe the following quickly. Either way, once it wears off, I'll probably be unable to understand any of this -- it contains my best approximation of the antimemetic script. But, this way, I at least hope to give my future self (once I'm back on the dose) a head-start on piecing the puzzle together.
...
SCP-9429-A was the hypothetical memetic complex responsible for the obscurity of the creators of SCP-9429. If it indeed existed, SCP-9429-A constituted a highly lethal ideatic object with the capability to annihilate, at least in mentally-held concept, and possibly physically, whomever interacted with or communicated it in a specific unclear capacity, and all associated ideasi.e. the cultural information associated with the OACG.. The composition, construction, and nature of such species of ideas is unknown to current memetic and antimemetic science.
...
<details>
<summary>+ Show excerpted selections from Project OBSIDIAN</summary>
...
**NOTE:** This file employs a modified version of the [Langford Index](https://scp-wiki.wikidot.com/i-told-you-about-spirals-bro) (a system for categorizing memes) for all simple memetic effects, and uses the according system of classification.
...
* *Delta-15-D9*, associated with the photic distortions produced after undergoing a rapid change in blood pressure.(e.g. after standing up quickly from rest)

* *Golf-20-D6*, associated with the sensation of disorientation in space accompanying the vestibular or locomotor aftereffect of being suddenly still after moving in place.(e.g. after stepping off a treadmill or trampoline after a long time)
...
They're actually shockingly simple, if anything. If not through introducing more dimensions of thought than the human mind can handle, I don't see what mechanisms here could be so corrosive as to annihilate not just the spreader or receiver of the meme, but broader memeplexes just by virtue of their vague *association* with them. That property remains unique. Almost makes me think it belongs to something deeper -- something of which we can see the sprouts, but not the roots. I have to assume the root is somewhere in this memeplex, somewhere in 9429-A: where else would it be?Black highlighter was apparently applied to this section of Dr. Hughes' journal some time after the fact. In any event, we'll keep looking for it in the Jasmine stringsJasmine Notation is a (now largely archaic) form of visual and glyphic code used in memetics to transcribe complex memes. It is used particularly for those concepts which can or should not be understood *directly* by conventional interface with the human mind, as the code was formed in such a way as to introduce a level of distance and abstraction between the mathematics of a meme's mechanical function its actual corresponding idea..
...
* *Delta-12-B8*, associated with the dizzying sensation of looking toward the sky in a complex structure.(e.g. toward a cathedral roof)
...
![](https://upload.wikimedia.org/wikipedia/commons/8/8d/Hexagonal_basalt_columns_at_Svar%C3%B0ifoss.jpg)
...
Just to be safe... you know, we're mighty hypocrites thinking we're keeping youUnclear who Dr. Hughes seems to be addressing. safe from this. We ~~tried~~ did all we could to ~~stop the flow of the idea, and we~~ isolate it but now we're alternating sessions decoding the main four or five memeomes and not sharing info until the next mnestic round. I've figured out there needs to be that extra layer of abstraction; we can't be directly communicating the roots to each other as we start to find them. ~~I fear it's already been a close call, I don't know how many times, and~~ We're worried that by this stage in the process ~~there's something else~~ Something that's dead is living at the bottom of the spiral, which is never good news. I'll forget this tomorrow, and you won't be able to read it, and it will be fine.
...
<details>
<summary>+ Show Recovered Project Proposal (5/4/1980)</summary>
...
<< [SCP-9428](SCP-9428) | SCP-9429 | [SCP-9430](SCP-9430) >>

=====

> **Filename:** Rocky Mountain N.P., panorámicas (1997) 03.jpg

> **Author:** LBM1948

> **License:** Creative Commons Attribution-Share Alike 4.0

> **Source:** [> **Filename:** Willow Peak volcanic cone.JPG

> **Author:** Jeffrey Beall

> **License:** Creative Commons Attribution-Share Alike 4.0

> **Source:** <https://commons.wikimedia.org/wiki/File:Willow_Peak_volcanic_cone.JPG](https://commons.wikimedia.org/wiki/File:Rocky_Mountain_N.P.,_panor%C3%A1micas_(1997)_03.jpg>(https://commons.wikimedia.org/wiki/File:Rocky_Mountain_N.P.,_panor%C3%A1micas_(1997)_03.jpg))(https://commons.wikimedia.org/wiki/File:Willow_Peak_volcanic_cone.JPG)

> **Filename:** Hexagonal basalt columns at Svarðifoss.jpg

> **Author:** Debivort at en.wikipedia

> **License:** Creative Commons Attribution-Share Alike 3.0

> **Source:** [[[/<](https://commons.wikimedia.org/wiki/File:Hexagonal_basalt_columns_at_Svar%C3%B0ifoss.jpg](https://commons.wikimedia.org/wiki/File:Hexagonal_basalt_columns_at_Svar%C3%B0ifoss.jpg))]
...
    background: url('https://scp-wiki.wdfiles.com/local--files/secure-facilities-locations/Site-41.svg');
...
    --title: "R\0026 C SITE-41";

    --subtitle: "There Is No Antimemetics Division";
...
span.blackfade:hover {

  background: transparent;   /* fade to clear */

  color: inherit;            /* return text to original color */
...
#page-content div:is(.note-nobody, .yui-content, .blockquote, .code, .mz-cover, .mz-textquote, .mz-outbox, .mz-blockquote,mz-board, .clip-wrap, .note-page, .mz-note ) h1{
...
    background-color: rgb(var(--clip-bg, 256, 256, 256));
...
font-family: 'Rochester', courier; font-size: 18px; !important;
...
@import ul('https://fonts.googleapis.com/css?family=Silkscreen');
...
font-family: 'Beth Ellen', courier;
...
font-family: 'Berkshire Swash', courier; font-size: 50px; !important;

}

.eidoSpeak{

font-family: 'Silkscreen', courier; font-size: 14px; !important;
