...
.cascade-img-1 { top: 0vh; left: 5%; width: 250px; }

.cascade-img-2 { top: 80vh; right: 10%; width: 280px; }

.cascade-img-3 { top: 160vh; left: 15%; width: 300px; }

.cascade-img-4 { top: 240vh; right: 20%; width: 320px; }

.cascade-img-5 { top: 320vh; left: 10%; width: 340px; }

.cascade-img-6 { top: 400vh; right: 15%; width: 360px; }

.cascade-img-7 { top: 480vh; left: 20%; width: 380px; }

.cascade-img-8 { top: 560vh; right: 10%; width: 400px; }

.cascade-img-9 { top: 640vh; left: 15%; width: 420px; }

.cascade-img-10 { top: 720vh; right: 10%; width: 440px; }

.cascade-img-11 { top: 800vh; left: 10%; width: 460px; }

.cascade-img-12 { top: 880vh; left: 2%; width: 480px; }
...
{{If you look out at the sea, on a moonless night, it doesn’t look like water at all. It looks like you’re at the edge of a cliff.}}

{{These days, I have bad dreams.}}

---

Hazard associated with certain facts, regardless of medium or form. anomaly. Information may not be presented in the intended order, and elements from other files may be interpolated with the main body of content. Read carefully, and stay alert. Keep close what is dear to you.

|object-number=‎ 

]]

.warning-box .image-bg {
...
**Special Containment Procedures:** Foundation surveillance arrays are to be on high alert for reports of YAMA events. Witnesses are to be interrogated and amnesticised. Discarded material, biological or otherwise, is to be processed and incinerated.
...
**Description:** SCP-9981 is a radio broadcast in the ██-██ AM band, detectable on a five-kilometre stretch of beach between ██████ Point and █████ Point, on the southwestern coast of England. Each broadcast, which lasts between thirty seconds and five minutes, occurs at unpredictable intervals. Gaps between broadcasts vary, but are on average one week, with the shortest recorded interval being thirteen hours.
...
{{That’s why I kept Peri around. Ri iked her classics, so Peri was for Peritas, Alexander’s mutt. He named a city after the little guy. The least I could do was feed her puppy.}}
...
**NOTES:** Survey of surrounding area notes unusual density of prey animals such as moose and elk, and an absence of bears. Further search locates several *Ursus arctos horribilis*Colloquially known as grizzly bears. which have expired due to cervical fracture.
...
{{If I had turned around five seconds later, if I had hesitated one more second for Ri-- for the *thing* that wore Ri’s face.}}
...
{{I still don’t understand anything. Why any of this happened, why me, why Ri. What the fuck was that thing *doing*?!}}
...
![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog1.JPG)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog2.jpg)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog3.jpg)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog4.jpg)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog5.JPG)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog6.JPG)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog7.JPG)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog8.jpg)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog9.JPG)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog11.jpg)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog12.JPG)

![](http://scp-sandbox-3.wikidot.com/local--files/whenweweredumb/dog10.JPG)

<details>
<summary>LEVEL 4 CLEARANCE REQUIRED TO VIEW CURRENT ITERATION OF FILE</summary>

.anom-bar-container.esoteric .text-part .main-class {

  --swatch-background: 250, 250, 250;
...
**Special Containment Procedures:** SCP-9981 instances are too numerous and integrated into mundane society to meaningfully contain. The Foundation is to maintain logs of SCP-9981 locations, concentrations, movement patterns, and unusual activity.

**Description:** SCP-9981 do not reproduce, shed fur, or age. Otherwise, they are indistinguishable from mundane canids, and currently number approximately seven million across the globe. They are believed to represent a “conservation effort” by the entities responsible for YAMA events, as described in the previous iteration of this file. During each event, an SCP-9981 instance was created, identical in appearance to the nonanomalous canid which was consumed.
...
<< [SCP-9980](SCP-9980) | SCP-9981 | [SCP-9982](SCP-9982) >>

> **Filename:**darkbeach.jpg

> **Author:** Ideophagus

> **License:** CC BY-SA 4.0

> **Source Link:** https://commons.wikimedia.org/wiki/File:Larache,_sea_side_at_night_2.jpg
...
> **Source Link:** https://commons.wikimedia.org/wiki/File:Night_House_in_the_Fog.jpg

> **Filename:** sheepdog.jpg

> **Author:** Томасина

> **License:** CC BY-SA 4.0

> **Source Link:** https://commons.wikimedia.org/wiki/File:Bulgarian_Shepherd_Dog_17.jpg 

> **Filename:** wolf.jpg

> **Author:** Vanessa Clausen

> **License:** Public Domain

> **Source Link:** https://commons.wikimedia.org/wiki/File:Wolf_Spitz.JPG 
...
> **Source Link:** https://commons.wikimedia.org/wiki/File:Police_dog_on_duty_at_Elmendorf_Air_Force_Base.jpg 
...
> **Source Link:** https://commons.wikimedia.org/wiki/File:A_puppy_sleeps.jpg 
...
> **Source Link:** https://commons.wikimedia.org/wiki/File:A_Golden_Retriever-9_(Barras).JPG 
...
> **Source Link:** https://commons.wikimedia.org/wiki/File:Golden_Retriever_with_a_stick_(Barras).jpg 
...
> **Source Link:** https://commons.wikimedia.org/wiki/User:Barras/gallery/Dogs#/media/File:Head_of_a_Golden_Retriever_lying_on_a_couch_(Barras).jpg 
...
> **Source Link:** https://commons.wikimedia.org/wiki/File:Golden_Retriever_in_a_puddle_(Barras).jpg 
...
> **Source Link:** https://commons.wikimedia.org/wiki/User:Barras/gallery/Dogs#/media/File:Golden_Retriever_Aik-3_(Barras).JPG 
...
> **Source Link:** https://commons.wikimedia.org/wiki/User:Barras/gallery/Dogs#/media/File:Golden_Retriever_Aik-2_(Barras).JPG 
...
> **Source Link:** https://commons.wikimedia.org/wiki/User:Barras/gallery/Dogs#/media/File:Golden_Retriever_Aik_on_a_couch.JPG 
...
> **Source Link:** https://commons.wikimedia.org/wiki/User:Barras/gallery/Dogs#/media/File:Golden_Retriever_afloat_(Barras).jpg 

> **Filename:** dog9.jpg

> **Author:** Barras (editing by )

> **License:** CC BY-SA 3.0

> **Source Link:** https://commons.wikimedia.org/wiki/User:Barras/gallery/Dogs#/media/File:Golden_Retriever_3_(Barras).JPG     
...
> **Source Link:** https://commons.wikimedia.org/wiki/User:Barras/gallery/Dogs#/media/File:Golden_Retriever_4_(Barras).JPG
...
> **Source Link:** https://commons.wikimedia.org/wiki/User:Barras/gallery/Dogs#/media/File:Golden_Retriever_sitting_in_snow_(Barras).jpg
...
> **Source Link:** https://commons.wikimedia.org/wiki/User:Barras/gallery/Dogs#/media/File:Golden_Retriever_2_(Barras).JPG

> **Filename:** scarydog.jpg

> **Author:** Oregon Department of Fish and Wildlife

> **License:** CC BY-SA 2.0

> **Source Link:** https://commons.wikimedia.org/wiki/File:Walla_Walla_wolf_%2817292447212%29.jpg

> **Filename:** spectrogram.png

> **Author:** X3K (a friend in DSP who prefers this pseudonym)
