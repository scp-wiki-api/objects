...
**User Recognition:**Recognition must be typed by the subject reading this file. {{Confirmed.}}

**Description:** [REDACTED]

---

= **##red|{{FILE REVISED. DISPLAYING NEW FILE ITERATION.}}##**
...
= **##green|{{OPENING SUPPLEMENTARY FILE.}}##**
...
# Aim the pistol at your forehead.
...
# Aim the pistol away from your body once the trigger has been pulled.

# Load one bullet into the pistol.

# Turn to face SCP-1463-A.

# Fire into SCP-1463-A.
...
= **##green|{{CLOSING SUPPLEMENTARY FILE.}}##**
...
*OI* **2.** Load the autoinjector. To do this, open the black cap on the autoinjector and attach it to the the connector on the mnestics container you have.^^*1 bullet fired, 6 bullets left*^^ Press the green button on the autoinjector and it will automatically load with a safe dose. Detach from the connector when,,*1 bullet fired, ~~15 bullets~~ 2 bullets fired, 4 left*,, the bar on the autoinjector is entirely green. *God damn amnestics are being eaten. Couldn't hide them behind the bookshelf. It's becoming the damn amnestics and **I keep forgetting** to do anything about it*{{No amnestics were present in the office.}}
...
= **##blue|{{DATABASE CONNECTION LOST FOR **0.5** MINUTES. FILE MODIFICATION CAN RESUME.}}##**
...
= **##red|{{IRRELEVANT INFORMATION EXPUNGED.}}##**
...
= **##red|{{THE COMPUTER IS UNNECESSARY TO READ THIS FILE.}}##**
...
<< [SCP-1462](SCP-1462) | SCP-1463 | [SCP-1464](SCP-1464) >>
