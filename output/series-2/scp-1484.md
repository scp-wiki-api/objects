...
When activated, the primary anomalous property of SCP-1484 is its effect on hadronic matter and quarks inserted within its internal chamber, including violation of conservation of baryon number, via the novel gauge field characterized by invariance of its Lagrangian under symmetries of gauge transformations**Explanatory note for non-expert personnel** (as mandated by special containment procedure file guidelines): A gauge is a tensor function by which one can vary the matter or gauge fields and preserve the Lagrangian (energy dynamics) of the system. The simplest concrete example is electromagnetism defined by electric field vectors  and magnetic field vectors , representable as a single 4-vector potential  via . Then  are invariant under the transformation by scalar gauge function  for  (note the Minkowski metric sign convention). The associated Lie algebra is , which generates a Lie group of gauge transformations via . These transformations have the property of preserving the covariant derivative when they act on the matter field . In other words,  for covariant derivative  (a motivation and derivation of this is in Document 1484-1-Mažeika). Other forces like the weak nuclear force and the SCP-1484 force will contain an extra commutator term due to mathematically, non-Abelian Pauli matrix basis, and physically, self-interacting/charged force-carrying bosons. These transformations are the Lie group of "symmetries" under which the gauge can be transformed: for electromagnetism, U(1), or the circle of radius 1 in the complex plane. This concept of "gauge" can be extended in other gauge theories for other forces, including the one in SCP-1484. *- Senior Researcher Mažeika* defined by the Lie group SU(5)As opposed to the above-the-Veil Standard Model, which uses the symmetry group . Even though the Georgi-Glashow SU(5) model is a somewhat inaccurate simplification versus other Grand Unified Theories of particle physics such as Lie algebra SO(10) or Pati-Salam, the rest of this Special Containment Procedures file will reference it for the purpose of clarity and ease of comprehensibility (containment team personnel should refer to Document 1484-7-Mažeika for more details on this point) *- Senior Researcher Mažeika*. This gauge field, motivated to represent a unification of quantum chromodynamics with the electroweak interaction into a single force, thus naturally couples quarks to leptons via interactions. The quantized force-carrying boson particles of this gauge field will be referred to as X and Y bosons per existing literatureCheng, T. P., Li, L. F. (2000). *Gauge theory of elementary particle physics*. Oxford University Press..

The referenced LagrangianLangacker, P. (1981). Grand unified theories and proton decay. *Physics Reports, 72*(4),287. https:*doi.org/10.1016/0370-1573(81)90059-4, which illustrates this relationship between quarks (such as up *u* and down *d*) and leptons (such as electrons *e* and neutrinos *ν//), is 

\mathcal{L} = \frac{g}{\sqrt{2}}X'^\alpha_\mu[-\epsilon_{\alpha\beta\gamma} \overline{d}_L^{c\gamma}\gamma^\mu d^\beta_L - \overline{u}_{R\alpha}\gamma^\mu \nu_R^c - \overline{u}_{L\alpha}\gamma^\mu\nu_L^c] 

\newline

# \frac{g}{\sqrt{2}}Y'^\alpha_\mu[\epsilon_{\alpha\beta\gamma}\overline{d}_L^{c\gamma}\gamma^\mu u_L^\beta - \overline{u}_{R\alpha}\gamma^\mu e_R^+ - \overline{d}_{L\alpha}\gamma^\mu\nu_L^c]

\newline

# \frac{g}{\sqrt{2}}X^\alpha_{s\mu}[\overline{d}_{L\alpha}\gamma^\mu e_L^- + \overline{d}_{R\alpha}\gamma^\mu e^-_R + \overline{u}_{L\alpha}\gamma^\mu\nu_L + \overline{u}_{R\alpha}\gamma^\mu\nu_R]

A detailed walkthrough of an example SCP-1484 interaction is provided in the testing log in Addendum 1484-2 and thus omitted for brevity.
...
-- [Dr. Cordelia Argent](SCP-2460 ) (Principal Researcher, Astronomical Phenomena Division)

<details>
<summary>+ Addendum 1484-1: Email Communications Regarding SCP-1484 Loan Request [LEVEL 4/1484]</summary>

From: Thomas Graham (tgraham@site-17.scp)

To: Ignas Mažeika (ignasmz@site-17.scp)
...
From: Ignas Mažeika (ignasmz@site-17.scp)

To: Thomas Graham (tgraham@site-17.scp)
...
I apologize for letting my home life bleed into my work. You know how she is, and she's only gotten worse with the recent [budget cuts](insurer-s-regret ) - I'm embarrassed to say, but since you asked, her birthday's coming up and I don't know what I can get her.
...
To: Jacques-André Parmelin (JAParmelin@site-mayim.scp)

Cc: Thomas Graham (tgraham@site-17.scp), Bernard Delebarre (bdelebarre@site-mayim.scp)
...
From: Jacques-André Parmelin (JAParmelin@site-mayim.scp)
...
<details>
<summary>+ Addendum 1484-2: SCP-1484 Test Log A (Site-Mayim)</summary>
...
We expect two up quarks to decay into a positron and an antidown quark(Cheng et al., 2000, p. 443), anomalously violating baryon number conservation (as we begin with 2 quarks and end with 1 quark and 1 lepton). This interaction is mediated by an X boson. 
...
<details>
<summary>+ Addendum 1484-3: SCP-1484 Test Log B (Site-17)</summary>
...
We expect a proton to decay into a positron and a neutral pion via an X boson. Note the above diagram includes the sub-interaction from Test 1484-A-1, although the same result would be obtained via a Y boson with the interaction from Test 1484-A-2. Note that the subsequent dominant decay mode with 98.823% branching ratio for the neutral pion is . 

**Notes:** The purpose of this test was to test SCP-1484's anomalous effect on baryons. This is the dominant decay mode for the proton, where we determined branching ratio  of interactions. Another aspect of the anomalous effect of SCP-1484 is that the decay rate Γ observed within SCP-1484 activations is significantly higher than the predicted equationMachacek, M. (1979). The decay modes of the proton. *Nuclear Physics, 159*(1-2),51. https://doi.org/10.1016/0550-3213(79)90325-0:

\Gamma = |\Psi(0)|^2FA^2\left(\frac{g^2(M)}{8M^2}\right)^2\sum{\mathcal{M}^2}
...
**Notes:** The purpose of these tests was to explore other proton decay modes in SCP-1484 and their branching ratios(Machacek, 1979, p. 49). H,,ns,, refers to any non-strange-quark hadronic endstate, while H,,s,, refers to any strange-quark hadronic endstate. 
...
**Input:** ^^3^^He (helium-3) nuclei beam
...
**Input:** ^^7^^Li (lithium-7) nuclei beam
...
<details>
<summary>+ Addendum 1484-4: Email Communications Regarding SCP-1484 Compute Approval [LEVEL 4/1484]</summary>
...
To: Megumi Miyamizu (meg@it.scp)

Cc: Thomas Graham (tgraham@site-17.scp)
...
From: Megumi Miyamizu (meg@it.scp)

To: Ignas Mažeika (ignasmz@site-17.scp)

Cc: Thomas Graham (tgraham@site-17.scp), Anuj Agarwal (aagarwal@it.scp), Sean Vogel (svogel@it.scp)
...
i have some concerns with this app. it's very dense, i can't understand, i need to so i can prioritize it vs other things when approving as IT director. we have many other competing large runs, like a new [scp-3334](scp-3334) memetic hazard detection training run and protein simulations for a cancer treatment synthesized from scp-████ and analytics' new scp detection algo. 
...
To: Megumi Miyamizu (meg@it.scp), Ignas Mažeika (ignasmz@site-17.scp)
...
To: Thomas Graham (tgraham@site-17.scp), Ignas Mažeika (ignasmz@site-17.scp)
...
thx for the talk/explain and the meal. when u said u were "taking me out for dinner" i didn't expect [https:*web.archive.org/web/20250617041817/https:*www.exploretock.com/sushiyoshizumi sushi yoshizumi] and a 30-yr-old bottle of hibiki whiskey. whered u even find it? ryoto-san's jealous. u know how much i miss home :) 
...
<details>
<summary>+ Incident 1484-1</summary>
...
To: SCP-1484 Containment Team (containment-team@scp-1484.scp)
...
A request by the [Fire Suppression Department](fire-suppression-department-hub ) for a reinvestigation into the circumstances of Dr. Davis's reassignment from SCP-1484 was denied by Site Director Graham, followed by a meeting with FSD leadership. Dr. Davis left Foundation employ three months later.

</details>

<details>
<summary>+ Addendum 1484-5: Email Communications Regarding SCP-1484 Misinfo Application [LEVEL 4/1484]</summary>

From: Ignas Mažeika (ignasmz@site-17.scp)

To: Kelly Lauren (klauren3@misinfo.site-17.scp)
...
From: Kelly Lauren (klauren3@misinfo.site-17.scp)
...
<details>
<summary>+ Addendum 1484-6: SCP-1484 Test Log C (Site-17)</summary>

**Test ID:** 1484-C-1

**Researcher:** Ignas Mažeika

**Input:** ^^204^^Pb nuclei beam
...
<details>
<summary>+ Incident 1484-3</summary>
...
<details>
<summary>+ Addendum 1484-7: Ethics Committee Investigation</summary>
...
From: Maxwell Davis (maxdavis@site-17.scp)
...
But it's actually worse than that, as Tests 1484-B-3 through 7 indicate a tiny probability of proton decay into strange matter, which could literally destroy the world in an XK-class scenario (see [SCP-6959](SCP-6959) for details).
...
 * enhanced security for high-ranking Site-17 personnel, including [retired personnel](proposal-of-expanded-protections-for-post-amnesticization-pe )
...
To: Ethics Committee (ethics-committee@ethics.scp)
...
One insane fact which I think encapsulates much about Sunny is that she spent her first years at [Site-43](secure-facility-dossier-site-43 ) before putting in a transfer request to Site-17. Of course everyone asked her why she did this, myself included, and she always gave the same answer: "The same reason I joined the Foundation: to make the world a better place." Sunny wasn't blind, she knew exactly what Site-17 was like and chose it intentionally, concluding her talents would better improve the world here than as another set of good hands there. 
...
> **Filename:** SCP_Test1-1.png

> **Author:** PandoraNuker

> **License:** CC BY-SA 3.0

> **Source Link:** [SCP Wiki](https://scp-wiki.wikidot.com/scp-1484)

> **Derivative of:** Proton decay3.svg

> ~~-~~-

> **Filename:** SCP_Test1-2.png
...
> **Name:** Proton decay3.svg

> **Author:** GreenRoot

> **License:** Public Domain

> **Source Link:** [Link](https://commons.wikimedia.org/wiki/File:Proton_decay3.svg)

> ~~-~~-

> **Filename:** SCP_Test2-1.png

> **Name:** Proton decay GUT simple.svg

> **Author:** Jotempe

> **License:** Public Domain

> **Source Link:** [Link](https://commons.wikimedia.org/wiki/File:Proton_decay_GUT_simple.svg)
