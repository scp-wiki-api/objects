...
    caption=A [*https://commons.wikimedia.org/wiki/File:Hallway_09.jpg space] connecting "test-test-testing.com"'s associated SCP-1549-A area and "jamies-website.com"'s associated SCP-1549-A area.
...
<details>
<summary>A: Beginnings of Containment</summary>
...
Due to a lack of any mentions of the websites or their properties being found anywhere onlineExcept for one unoffensive mention of "normalmail.com" by user JaJa2020 on the █████████ Forums, asking if "anyone else used this weird website" to which only one user, named Normal_Pearson, responded with "no twat" {{[sic]}}., suppression of the websites was deemed a low priority (Code Green), and furthermore would be an impediment to experimentation.
...
> **To:** ##BB0011|{{[variable]}}@normalmail.com## **From:** no.reply2020@normalmail.com

> ~~-~~

> For the sake of user safety, we're going to keep things on the down low! For this absolutely normal website that does nothing interesting in the slightest. We've got some visitors who seem to be interested in our website, so we're just going to keep things simple. Go to ##BB0011|this##Link returned a 404 Error approximately 60 minutes after the email was sent. link and download the plugin. In an hour, all websites made by myself will cease to work unless you have the plugin. Only share this with other established users!
...
<details>
<summary>B: Continued History of Containment</summary>
...
> **To:** representative1549@normalmail.com **From:** no.reply2020@normalmail.com
...
> **To:** no.reply2020@normalmail.com **From:** representative1549@normalmail.com
...
<details>
<summary>C: Appropriation of SCP-1549-A</summary>

Operation "Aggressive Networking" directors and operatives prepared for a military takeover of SCP-1549-A and detaining of PoIs following the first test of the Foundation Transportation Network Wormhole Device. [*http:*www.scp-wiki.net/task-forces#lambda-5 MTF Lambda-5 ("White Rabbits")] was deployed and successfully secured positions at all eleven portalsThe nine active ones, and the two inactive portals created along with "jaja-artgallery.com" and "coolnormalgames.com". and then proceeded to search SCP-1549-A for any PoIs. After none were found, Modifed [http:*www.scp-wiki.net/scp-3001 Lang-Scranton Spacial Stabilizers] (offshoots of the Scranton Reality Anchor designed to disrupt Class-B "Information Superhighway" Wormholes A proposed technological singularity that could act as a means of transfer of matter into informational constructs.) were deployed. After three portals were successfully closed, all remaining PoI-1549 created portals became inactive. Investigation revealed that all domains originally containing SCP-1549 instances had become unavailable with the exception of "normalmail.com", which was found to become non-anomalous. The following email was received two minutes after this event:
...
<details>
<summary>D: Final Interaction w/ PoI-1549</summary>
...
<< [SCP-1548](SCP-1548) | SCP-1549 | [SCP-1550](SCP-1550) >>
