...
| Setting Nine "Punish." | The operator of the device will be given complete control of the composition of the person within SCP-1725 via a command terminal. Any changes made to the subject's body will be extremely painful to the subject, and can lead to their death. Changes can be reverted at the operator's choice.It is believed that [SCP-1808](SCP-1808), recovered later in Somerset, England, was acquired to cater to clientele intrigued by the demonstration of this option. |
