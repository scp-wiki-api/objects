...
**Addendum 1785-1:** Previously, attempts at crossbreeding and planting seeds from Alexia have had neutral results, with new growths seemingly displaying no effect on researchers. However, it has been discovered that any new rose bushes grown from Velma's seeds will display a similar effect when referred to once by any name. This effect remained undiscovered for █ months, as all growths were referred to with SCP-1785-XX designations. Researchers did not realize they were unable to use any name but their designations and the pronoun 'it' until Dr. ██████ used the name Rosie before assigning a number. Rosie can only be called Rosie, but she *can* be referred to with feminine pronouns.
