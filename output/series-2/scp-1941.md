...
In the decade since it was discovered, the area the phenomenon encompasses has grown by a factor of 3.5, giving it an estimated doubling rate of 7 years. It currently occupies an area of 250,000 km^^2^^ (6% of the moon's surface, or roughly the area of the United Kingdom). If it continues to spread at the same rate, it will begin to be visible from Earth in August of 2023. The entire moon's surface would be covered by 2040.
...
The lower-bound placed on the amount of energy released is 4.2 x 10^^18^^ Joules,  deemed acceptable (roughly equivalent to a gigaton nuclear explosion). The upper-bound, however, has been placed at 3.1 x 10^^44^^ Joules, or roughly the amount of energy released by the average supernova. Research is currently underway to refine these bounds.
...
The lower bound is estimated using the expectation that, on average, as the number Ω approaches infinity,  Ω will have  Ω number of prime factors. The upper bound is estimated using the assumption that the number Ω represents the pathological case and is itself prime.
...
> **Source Link:** [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Moon_Farside_LRO.jpg)

> **Derivative of:** Moon Farside LRO.jpg by NASA, Public Domain

> **Filename:** sponge-fractured.jpg

> **Author:** NASA, 

> **License:** CC BY-SA 3.0

> **Source Link:** [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Hyperion_false_color.jpg)

> **Derivative of:** Hyperion false color.jpg by NASA, Public Domain
