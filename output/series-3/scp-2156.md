...
During an active state, items in SCP-2156's vicinityThis is generally limited to the room that SCP-2156 is in, except when the room has relatively few items that would be affected by the active state. The standard furnishings of a T5HCC are more than sufficient to limit an active state's effects to SCP-2156's cell. will be altered in one of several ways outlined below:
...
SCP-2156 perceives its active states as though it is playing several consecutive games of KlondikeA patience game, known as "solitaire" in the United States, played with a standard 52-card deck. with the interface associated with the game's inclusion in the Windows 7 operating systemRecords recovered from SCP-2156's personal computer indicate that, prior to recovery, SCP-2156 had played Klondike solitaire with this interface 2704 times, with a win percentage of 52%.. While SCP-2156 reports that it has control over the cards within the rules of the game, it is unclear whether its actions directly translate to the events that occur during an active state. SCP-2156 firmly believes that meeting some unidentified criteria during an active state will cure its insomnia.
...
<< [SCP-2155](SCP-2155) | SCP-2156 | [SCP-2157](SCP-2157) >>
