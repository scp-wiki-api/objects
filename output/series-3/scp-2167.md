...
**Special Containment Procedures:** SCP-2167 is to be stored in a soundproofed containment locker, connected to a CD player, four 5W speakers measuring at minimum 4 on the infinite grade impairment scaleSee [https:*web.archive.org/web/20231101054348/https:*www.soundexpert.org/documents/10179/11017/se_igis.pdf this paper] for information regarding the methodology to determine this. (hereafter IGIS), and a 12VDC 5A uninterruptible power supply with at least 300 amp-hours of capacity. The speakers are to be positioned around SCP-2167 at 90±5° angles at a maximum distance of 0.5 m. The locker is also to contain a small number of music CDs and vinyl records containing non-sensitive material alongside SCP-2167.
...
All testing is to be conducted in a soundproofed room measuring 4.8 m wide, 7.8 m long, and 3 m highThese dimensions are those of a golden cuboid; this geometry provides excellent sound damping. A smaller room may be used instead, but the ratio of side lengths need to remain the same.. Except per specific testing protocol, SCP-2167 is to remain connected to the CD player and UPS at all times. During standard testing it is to be connected to a pair of 25W speakers scoring at minimum 5 on the infinite grade impairment scale. The speakers and a chair are to be positioned in a golden cuboid arrangement as per document 2167-F.
...
The psychoacoustic loudness , measured in sones, is characterized by Equation (), where  is the expected loudness as determined from physical measurement,  is the position of the "volume" dial in the range 0-10, and  is the real extension of the Ackermann–Péter function.
...
The area of effect relative to SCP-2167 can be modeled by the inequality , where  is described by Equation ().
...
In these equations,  and  represent the location relative to SCP-2167 and the IGIS of all audio devices,  is the Heaviside step function, and c,,2,, and c,,3,, are constants whose values have experimentally been determined to be:

c,,2,, = 6.152 m^^-1^^

c,,3,, = 0.468 m^^-2^^

In the case of the second effect,  represents the (non-normalized) probability that a given recording will be played.

<details>
<summary>+ show affected area simulation</summary>

<iframe id="sim" src="https://openprocessing.org/sketch/376799/" scrolling="no" style="width: 500px; height: 687px;"></iframe>
...
Scanning electron microscopy imaging has revealed unusual structures on the silicon IC die inconsistent with any known theory of operationSimilar markings are likewise noted in the schematics recovered for [SCP-1576](SCP-1576)..

<details>
<summary>+ show SEM imagery</summary>

[[include <a href="/component:image-block">component:image-block</a> name=EEInM5g.jpg|width=600px|caption=SEM image showing SCP-2167's amplifier IC. ([EEInM5g.jpg bigger version]) ]]
...
<< [SCP-2166](SCP-2166) | SCP-2167 | [SCP-2168](SCP-2168) >>

=====

> **Filename:** Gauchito78.jpg

> **Name:** Gauchito-78 (Ariel Minimal Drive Master Signature) (2013-05-18 16.48.51 by Andrés Galeotti).jpg

> **Author:** Andrés Galeotti

> **License:** CC BY-SA 2.0

> **Source Link:** [Wikimedia](https://commons.wikimedia.org/wiki/File:Gauchito-78_(Ariel_Minimal_Drive_Master_Signature)_(2013-05-18_16.48.51_by_Andr%C3%A9s_Galeotti).jpg)

> **Filename:** EEInM5g.jpg

> **Author:** AJMansfield

> **License:** CC BY-SA 3.0

> **Source Link:** [SCP Wiki](http://scp-wiki.wikidot.com/scp-2167)
