...
Under no circumstances are Foundation personnel to use remotely controlled vehicles to dispose of instances of SCP-2283, although if no other situational alternative exists, the acting HMCL supervisorsCurrently Drs. Christiaan Makeba and Peter Fredriksen. may authorize the use of Class D resources to perform this task. Personnel should refer to Incident Log 2283-12 for more information.
...
Partial data on non-anomalous aspects of SCP-2283-A's molecular composition is to be added to the Threat Recognition Analytics Certified Realtime (TRACR)The Foundation's real-time threat detection and situational awareness technology, incorporating a variety of sensors and a "weak" AI. TRACR MK VII is in deployment with most major site security forces and MTFs as of ██/██/████. forensic database to aid Foundation anterior detection and containment efforts. Foundation police liaisons in all regions where instances of SCP-2283 have been deployed or are suspected to be deployed must be trained in the item's detection, and are to alert their regional command upon reasonable suspicion of such deployment.
...
However, the explosive component of each SCP-2283 instance is composed of SCP-2283-A, an unknown material superficially resembling RDX (PVV-5A), but with several unexplained physical properties Recorded differences include a resting temperature of 51.68-54.23 degrees Celsius, significantly higher shock sensitivity, emission of visible light in the range of 450-570 nm wavelength, and [REDACTED]..

Every recorded instance of the detonation of an instance of SCP-2283 has resulted in damage to nearby inanimate objects as would otherwise be expected for a non-anomalous RDX device of an equivalent yield. However, persons within the blast radius of an SCP-2283 instance will not suffer the effects of said explosion, but will instead instantaneously vanish along with all possessions on their person i.e. clothes, wallets, cell phones, etc. from known space, and mirror the creation of SCP-2283-B, Class 4 Incorporeal Entities Lacking full intangibility; i.e., unable to interact with, but still bounded by, physical matter. with unique characteristics.
...
<details>
<summary>INCIDENT LOG 2283-12</summary>
...
<details>
<summary>ADDENDUM-2283-1</summary>
...
<details>
<summary>INCIDENT LOG 2283-292</summary>
...
<< [SCP-2282](SCP-2282) | SCP-2283 | [SCP-2284](SCP-2284) >>

=====

> **Filename:** detonation.png

> **Name:** Size0-army mil-44434-2009-07-10-090719.jpg

> **Author:** United States Army

> **License:** Public Domain

> **Source Link:** [Wikimedia](https://commons.wikimedia.org/wiki/File:Size0-army_mil-44434-2009-07-10-090719.jpg)

> **Filename:** aftermath.jpg

> **Name:** Northwest Portland explosion aftermath 07.jpg

> **Author:** Kingofthedead

> **License:** CC BY-SA 4.0

> **Source Link:** [Wikimedia](https://commons.wikimedia.org/wiki/File:Northwest_Portland_explosion_aftermath_07.jpg)
