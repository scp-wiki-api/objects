...
**Description:** SCP-2608 is a largely unstudied mayfly species *(Stenonema nephilim)* native to the Pacific Northwest. It is thought to have spread across the wetlands of North America in the last two decadesBased on the vulnerability of SCP-2608 populations to certain phenomena, it has been suggested that this is due in part to Foundation activity, as the containment of such phenomena would allow SCP-2608 to colonize previously hostile environments. However, there is not currently definitive proof of this., outcompeting related species due to a marginally more efficient metabolism.

SCP-2608 imaginesThe sexually mature adult stage of an insect. can be distinguished from related species by their relatively larger eyes and relatively more translucent bodies—however, these differences are subtle enough that they cannot be readily identified by unqualified individuals. SCP-2608 subimaginesA winged, but not yet fully developed and not yet fully mature sub-adult stage unique to order Ephemeroptera. and SCP-2608 naiadsThe aquatic juvenile stage of a mayfly. cannot be reliably distinguished from related species by any means outside of DNA examination. 

SCP-2608 was first brought to Foundation attention when the population experienced a then-inexplicably widespread die-off in the spring of 2005 now thought to be the result of the ten day delay in containment of [SCP-1425](SCP-1425 ).See [SCP-1425](SCP-1425 ) documentation for details. The species has since been restored to its former range.
...
While the exact chemical manner in which SCP-2608 individuals are affected varies greatly based on the phenomenon in question and its source, there are two "rules of thumb" that can give rough insight into the strengthThe nature of the phenomenon in question cannot be determined via SCP-2608's reaction to it without both extensive laboratory testing and prior knowledge of the phenomenon. and proximity of the phenomenon;

* The general health of an SCP-2608 population can be regarded as an estimate of how close its surroundings are to its natural environment.A local spacetime marsh, free of psychic interference.
...
<details>
<summary>+ PRESENT STATUS OF SELECT 2608-AWS - LEVEL 4 SECURITY CLEARANCE REQUIRED</summary>
...
| **Provisional Site-23 | ** ##E5E500|ELEVATED DISTURBANCE## |
| **Provisional Site-27 | ** UNDISTURBED |
| **Provisional Site-██ | ** UNDISTURBED |
| **Provisional Site-98-1 | ** UNDISTURBED |
| **Provisional Site-98-2 | ** ##98FB00|LOW DISTURBANCE## |
...
| **Provisional Site-███ | ** ##98FB00|LOW DISTURBANCE## |
| **Provisional Site-193 | ** ##98FB00|LOW DISTURBANCE## |
| **Provisional Site-███ | ** UNDISTURBED |
...
| **Facility ID** | **Facility 2608-AWS Average Disturbance Status** |
| **Site-06 | ** UNDISTURBED |
| **Site-██ | ** ##98FB00|LOW DISTURBANCE## |
| **Site-19 | ** ##98FB00|LOW DISTURBANCE## |
| **Site-64 | ** UNDISTURBED |
| **Site-77 | ** UNDISTURBED |
| **Site-118 | ** ##98FB00|LOW DISTURBANCE## |
...
| **Facility ID** | **Facility 2608-AWS Average Disturbance Status** |
| **Area-02 | ** UNDISTURBED |
| **Area-12 | ** ##98FB00|LOW DISTURBANCE## |
| **Area-13 | ** UNDISTURBED |
| **Area-14 | ** ##98FB00|LOW DISTURBANCE## |
| **Area-58 | ** ##98FB00|LOW DISTURBANCE## |
| **Area-179 | ** UNDISTURBED |
| **Area-██ | ** UNDISTURBED |
| **Area-354 | ** ##red|CRITICALLY DISTURBED## |
| **Area-██ | ** ##98FB00|LOW DISTURBANCE## |
| **Area-██ | ** UNDISTURBED |
</details>
...
**Addendum:** - 4/10/2015 - With the exception of the Site-62 population,The Site-62 population remains at full health. all SCP-2608 populations have declined a further 1.8%. 2608-AWS warning allowances have been updated to compensate.
...
<< [SCP-2607](SCP-2607) | SCP-2608 | [SCP-2609](SCP-2609) >>

=====

> **Filename:** IMG_20160729_145252.jpg

> **Author:** gemcuttlefish

> **License:** CC BY-SA 3.0

> **Source Link:** [SCP Wiki](http://scp-wiki.wikidot.com/scp-2608)
