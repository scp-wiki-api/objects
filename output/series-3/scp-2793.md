...
Detailed analysis of single instances of SCP-2793 has revealed engineering and materials far in advance of current technologies. Such technology includes quantum processorsCapable of representing twice the number of bits when compared to normal processors through the use of 11, 10, 01, 00 bits instead of just 1 and 0 and nano electrokinetic thrusters.An advanced form of space propulsion that uses the principles of electro-osmosis to generate thrust. To date, SCP-2793 instances acquired by the Foundation have been reverse engineered and the new technologies are currently being deployed in experimental models.
...
<< [SCP-2792](SCP-2792) | SCP-2793 | [SCP-2794](SCP-2794) >>

=====

> **Filename:** Nano1(1).png

> **Author:** Praetor Avacyn

> **License:** CC BY-SA 3.0

> **Source Link:** [SCP Wiki](http://scp-wiki.wikidot.com/scp-2793)

> **Filename:** Nano2(1).png
