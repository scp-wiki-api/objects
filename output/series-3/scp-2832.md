...
**Special Containment Procedures:** Prototype Testing Facility 145 has been evacuated, with only a skeleton crew remaining to monitor SCP-2832. Site-22 will no longer be used to contain anomalous objectsWith the exception of SCP-████, which is immobile., instead serving as a staging area for the SCP-2832 containment team.
...
**Description:** SCP-2832 is an unstable cylindrical spatial anomaly with a radius of 11.45 metersAs of 31/12/2016., centered around SERS Prototype Unit Xi-2 in Prototype Testing Facility 145The [SERS](http://www.scp-wiki.net/scp-2660) is a device meant to counteract changes to local reality. Other SERS prototypes have been utilized by the Foundation without incident..
...
A partial list of activation events is found below; for a full list, see the researcher in charge of containment.As of 08/05/2011, Doctor Mirtha Kaas.
...
-2.9It should not be possible for a Kant counter to register a negative Hume rating. Equipment was rotated after this event, but diagnostics found no issue.
...
<details>
<summary>+ Exploration Log 2832-04</summary>
...
<details>
<summary>+ Level 4/2832 clearance or higher required</summary>

> On 30/12/2016, SCP-2832 entered its active phaseWith a Hume reading of 79.1., displaying view of a dimly-lit cavern. Lateral to the aperture is section of wall in the shape of a chair. Seated upon it is a humanoid entity, approximately 4.5 meters in height, with lavender skin and eight eyesArranged in ring on face. No other facial features present..

> 

> Entity appears to notice it is being observed and turns to address personnelPersonnel report hearing entity speak in multiple languages at once, with their native language most audible.:

> 

>> I did not expect to see you so soon, child race. You have taken too large a step. What you seek is not here, and what is here, you cannot control. So much of what you perceive is incorrect. Filter the unnecessary and focus on that which lies within. Given time, you will join us, but not before.Junior Researcher Reigh given commendation for quick thinking in transcribing message.

> 

> Entity lifts handPersonnel describe inconsistent number of digits, with sole note of agreement being that two seem to have been severed at the fourth joint., and SCP-2832 enters its passive state. Kant counter malfunctions during next scheduled Hume reading; period of 24 hours required to restart and calibrate unit. SCP-2832 does not reenter active state during this time.
...
<details>
<summary>+ End Note from Dr. Mirtha Kaas</summary>
...
<details>
<summary>+ Rebuttal from Dr. Joyce Ettinger</summary>
...
<< [SCP-2831](SCP-2831) | SCP-2832 | [SCP-2833](SCP-2833) >>
