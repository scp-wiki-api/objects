...
> *The database search already excludes infohazards, so you don't need to worry about that.*- [ Rosen](david-rosen-file)
...
>> *Anything keyed to specific phrases, numbers, etc. could be unreliable if the anomaly goes off-script. That should be the guiding containment principle.*- [Graff](SCP-2357 )
...
> 
<details>
<summary>+ Display interview snippets (translated from Italian)</summary>
...
<< [SCP-2863](SCP-2863) | SCP-2864 | [SCP-2865](SCP-2865) >>
