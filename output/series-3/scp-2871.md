...
**Special Containment Procedures:** The original three prototype instances of SCP-2871 are to be maintained in an archival state for study. Operation of these instances is prohibited, as they possess multiple design flaws.  See *Addendum 2871-3: Failure Analysis of Pre-Containment SCP-2871* 
...
No more than 1 kg of matter should be exposed to SCP-2871-1 during a single activation.  Personnel are reminded that atmospheric density at sea level is 1.2 kg/m^^3^^. Exposure of elements including isotopes thereof with atomic mass greater than 28 to SCP-2871-1 requires site director authorization. 
...
**Description:** SCP-2871 is a device capable of amplifying the range of gluon-mediated interactions commonly referred to in physics as the Strong Interaction  between baryons The class of subatomic particles which includes protons and neutrons, the primary components of atomic nuclei. within a small targeted region.  
...
* the distance at which atomic nuclei experience mutual attraction expands to ranges comparable to atomic radii.  Due to force inversion effects, the size of atoms remain relatively unaltered; typical reductions in radius are between 10-30%, similar to the reduction seen in Lambda-Lithium(Λ7Li). As a result, incidental collisions between atoms can cause two nuclei to fuse, a phenomenon normally seen only in high energy collisions such as those achieved in particle accelerators. 
...
 Individual components of SCP-2871 instances are non-anomalous, and largely consist of off-the-shelf consumer and industrial electronics in a layout loosely resembling the klystrons compact combination emitters/tuners/amplifiers of high-energy electromagnetic radiation found in large telecommunications transmitters, radar arrays, and linear particle accelerators. On a purely functional level, known contributing factors to the devices' anomalous properties include the unusual convoluted shape of the resonating cavity, a complex pattern of knots and braids formed by the internal wiring, and the relative locations of several unpowered, seemingly extraneous internal components. Notably, powering said components will cause SCP-2871 to cease operation. 
...
| **10:57:** | HEED array a Foundation-maintained network of microsatellites and ground-based sensors equipped with scintillation counters, wide spectrum imaging cameras, and InSAR seismic topography systems dedicated to **H**igh-**E**nergy **E**vent **D**etection. detects a minor sustained emission of wide-band radiation from a remote area of west Texas. Event is automatically flagged as potential anomaly. |
...
While reprimanded for the destruction of the functional instance of SCP-2871, MTF Gamma-103 was also commended for resolving the situation with minimal casualties, and with relatively minor damage to, and irradiation of, the surrounding region. Explained to media and local officials as the detonation of a large experimental refinery producing aviation-grade biofuel from tobacco cultivation waste.  
...
<< [SCP-2870](SCP-2870) | SCP-2871 | [SCP-2872](SCP-2872) >>
