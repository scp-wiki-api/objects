...
SCP-2906 prevents observers from mentally connecting its agentsDiscovered examples include buildings, various paper documents, and their associated businesses. Other examples include packaging and anomalous art. to SCP-2906-1. Trained personnel are able to identify if a cognitohazard is present; however, they are not immune to its effects and are unable to successfully identify SCP-2906-1 or associate objects affected by SCP-2906 with each other.
...
SCP-2906-1 is the target concept blocked by SCP-2906. An incomplete list of target concepts utilizing SCP-2906 at some point has been recorded in Addendum 2906-D. It can safely be assumed they are familiar with the creation of cognitohazards, as well as the Foundation.
...
> *[At this point, Factor hands over copies of [SCP-1360](SCP-1360)'s documentation to all parties.]*
