...
Researchers are to call SCP-3242 "the subject" if mention of it is ever necessary.This became necessary after an incident where the subject became the rodent cage itself. 
...
The subject currently resembles *Mus musculus* or House mouse, of the BALB/cAn inbred model of laboratory mice. strain. Iterations can be identified by random, increasingly regular superficial changes in characteristics also specific to the species or "grouping" of the iteration appearance. 
...
The mass, weight, and physical capabilities of each iteration are determined by species and/or stereotyping. Individuals unaware of the subject are unable to be touched by the subject. Complications involving the subject and staff uninformed of the subjects' location are to be noted in later performance reviews.
...
Anything that the subject consumes is returned without any loss in mass. All materials consumed become their individual ingredients This was determined from samples tested with analytical chemistry. Because the organs only mimic their original functions, this is being studied.that previously constituted the former, albeit with an unusual color and viscosity.
...
# "Soft" masses that follow staff randomly. Changes in shape, size, and color are common. These characteristics seem to be influenced by emotion. No clearly aggressive or determined behavior has been observed. Physical contact fails or causes the specific mass to "burst" and vanish.
...
![](https://upload.wikimedia.org/wikipedia/commons/2/29/The_strange_woman_and_her_spirits%2C_1621._Wellcome_L0000582.jpg)

Note: The USB had been inserted into a powered computer when this occurred. The file was assumed to have opened itself, as its contents were displayed in Wordpad A prepackaged program.. Video surveillance did not reveal any physical interaction with the equipment or movement beyond changes on the screen. The electronics involved were inspected and moved outside the known affected area.
...
Note: This was on the phoneA Blackberry. of Mr. Garabedian.  Despite the loss of possible communication, Garabedian was not reprimanded for destroying the affected object. The memory card was saved.
...
{{InVIV Manufacturing}}This company does not seem to exist. {{Prototype}}
...
<< [SCP-3241](SCP-3241) |  SCP-3242 | [SCP-3243](SCP-3243) >>
