...
-- Ernesto Gomez, Assistant Director at the Observatory of the Groups of Interest, and Leo Camfield and Lisbeth Bjornstrand, Research Leads for GoI "SAPPHIRE".
 ...
 or )A number greater than zero but less than any positive real number. represents infinitesimal numbers, and omega ()An ordinal number that represents the order of the natural numbers. represents infinite numbers. Click to enlarge.|

    link="*/local--files/adult:SCP-3380/Surreal_number_tree.png"
...
Individuals affected by SCP-3380 will become an SCP-3380-A instance. The instance will carve a diagram resembling the surreal number system A totally ordered class containing all real, infinite, and infinitesimal numbers. The latter two have absolute values larger or smaller than any real number. tree onto their body, using any available methods to do so. After five minutes the subject inscribes  and  at the bottom of the tree, and ceases carving. The subject will then undergo psychological changes, which include a fixation on transfinite numbers Numbers that are "infinite" in that they larger than all finite numbers, but not absolutely infinite. and Austrian-American logician Kurt Gödel, who is usually assigned deity-like qualities despite commonly held atheistic beliefs. {{Further details are in Addendum.3.}} 46% of instances will continue to carve mathematical expressions and symbols following initial carving. Beliefs will often morph into what appears to be expression of religious nature.
...
This letter is notable for being the first instance of the phrase "Epsilon Nought" Likely referring to the number epsilon nought (), an ordinal equal to  (omega to the power of omega repeated infinitely).  in relation to the object of worship in SCP-3380.
...
> I scraped the last dried seed from my mind and saw a part of the spine that wasn't eaten, minute and curled around zero. The inverse of the inverse of the inverse of the inverse of 7. The real 7. The 7 that slinks with theta and adds up to zero no matter what you do. The fetus should've been strangled but we knew it was too cute for that. It was a grand forest of epsilons (positive and negative and squared and rooted and ) but we knew the heart wasn't that big. The infintesimals at the end of infinity lock my heart. I went down its spiral to the smallest abyss, and I ended up **below**. I looked **below**, and it smiled.
...
<< [SCP-3379](SCP-3379) | SCP-3380 | [SCP-3381](SCP-3381) >>
...
> **Source Link:** [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Surreal_number_tree.svg)
