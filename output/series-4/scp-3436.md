...
([More from this author.](scpcrnp-s-author-page))
...
/* -free replica of the janky (rev. 42). Mostly accurate.

 * Unofficial change. See revision history.

 * Simpler version with less effects:

 * ##gray|(Redirected from *Provisional Site 3436*)##

 */

@keyframes load_in{ to{ font-size: small }}
...
  animation: load_in 0.5s step-end forwards;

  color: gray;

}

.jank::selection, .jank em::selection{ background: transparent }

(Redirected from *Provisional Site 3436*)
...
Access into the building is exclusive to the Site Director and accompanying Engineering and Technical Service Department Class C/D personnel who have been consented ([Form 3436-A](consent-form-3436-a)) and briefed to Level 2 security clearance.
...
<details>
<summary>+ Evidence Regarding Origins</summary>
...
<details>
<summary>+ Security Clearance Level 2</summary>
...
**Result:** ABE x2. Both ascents impeded by the roofs of the D9Rs. The driver-side window of D2's D9R was lowered at the time of the event; D2's body moved laterally along the roof, then out the window with subsequent and complete ascent. D1 was fully enclosed in the vehicle and found as pomace The pulpy matter remaining after some other substance has been pressed or crushed. . The doors of D1's D9R were opened by recovery personnel, one of whom was contacted by D1's remains as they responded to the newly introduced egress from the D9R; ABE x1, complete ascent, followed by complete ascent of D1's remains. Two heavily-modified D9Rs retrieved.
...
<details>
<summary>+ Security Clearance Level 3</summary>
...
= << [SCP-3435](SCP-3435) | SCP-3436 | [SCP-3437](SCP-3437) >>

[!--

> **Filename:** RedoneSCP3436

> **Author:** scpcrnp

> **License:** 

> **Source Link:** [/scp-3436 SCP Foundation Wiki]

> **Derivative of:**

> ----

> **Name:** Len Lye Wind Wand

> **Author:** Robin van Mourik

> **License:** CC BY-SA 2.0

> **Source Link:** [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Len_Lye_Wind_Wand.jpg)
