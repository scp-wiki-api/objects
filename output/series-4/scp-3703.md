...
<details>
<summary>ENTER CREDENTIALS FOR fileserv:/S/3703/experiment.log</summary>
...
(*The retrieval cable activates but snaps.A post-incident investigation determined this was the result of a previously undetected fault in the wire. Notable anatomatical changesThese include the manifestation of scales and fins along the right leg. occur during fusion prior to the onset of rapid necrosis.*)
...
<details>
<summary>ENTER CREDENTIALS FOR fileserv:/S/3703/exploration.log</summary>
...
*Blue light visibly arcs and stretches from the object into the cloud. Estimated to be roughly 30 km in height, and 5-7 km in width Within the interior of the sphere is a female humanoid individual; matching the anatomical features of corpses within SCP-3703, with golden scales. The camera zooms in, and the individual's chest can be seen rising and falling. Its eyes are closed.*

*15 seconds pass without incident. The humanoid opens its eyes and spots the drone. Its mouth moves, and it points in the direction of the camera. An arc of light strikes the drone, severing all contact with the vehicle.Audio recording peaked prior to loss of contact, full analysis is under way to retrieve verbal communication.*
...
<details>
<summary>ENTER CREDENTIALS FOR fileserv:/S/3703/document-A.txt</summary>
...
The entity observed in this recording has been designated EoI-001-01.Entity of Interest. Efforts are currently underway to counteract a potential HK-class deific subjugation scenario.
...
<< [SCP-3702](SCP-3702) | SCP-3703 | [SCP-3704](SCP-3704) >>
