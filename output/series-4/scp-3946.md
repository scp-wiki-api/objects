...
@import url('https://fonts.googleapis.com/css?family=Caladea|IM+Fell+DW+Pica|IM+Fell+DW+Pica+SC|Tangerine|Indie+Flower|Courgette');
...
    background: linear-gradient(rgba(220, 240, 240, 0.3), rgba(240, 240, 220, 0.5)), url(http://www.scp-wiki.net/local--files/theme:unusual-Cargo/TOAST-PAPER.jpg);
...
> {{A member of the Central Atlantic Foundation Fleet has failed to respond to hourly hailing signals. The Alertness level in the CAFF has elevated to **##ced128|Yellow##**.}}
...
> {{The date is 19/08/21. A member of the Central Atlantic Foundation Fleet has been overtaken by a hostile anomalous entity. The Alertness level in the CAFF has elevated to **##red|RED##**.}}
...
<< [SCP-3945](SCP-3945) | SCP-3946 | [SCP-3947](SCP-3947) >>
