...
This effect makes it difficult to ascertain the exact nature of the correlation between SCP-4018-A's control over SCP-4018 and its success, as subjects who consider the two concepts identical will fail to make the distinctions necessary to properly trace cause and effect.Generally, this is considered a trivial or nonsensical problem, akin to considering the correlation between a phenomenon and itself. Relevant records made while SCP-4018 is active have not been interpreted usefully after the fact, and are often barely legible.
...
|| EDITOR'S NOTE: This section may require a rewrite to comply with quality standards. _
...
<< [SCP-4017](SCP-4017) | SCP-4018 | [SCP-4019](SCP-4019) >>
