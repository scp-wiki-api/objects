...
<details>
<summary>  a. Initial Meeting & Observations: Display Audio Transcript</summary>
...
**Carla D. Hayden:**The 14th Librarian of Congress. Welcome, welcome. Thank you all so much for coming today.
...
*At this time, Agent Wells collects the books and motions to the UIU agents to leave. They walk up the staircase and return the headphones to the librarian.*
...
<details>
<summary>  b. Digital Correspondences: Display Files</summary>
...
<details>
<summary>  c. MTF Beta-14 Exploration Log: Access Transcript</summary>

*The Foundation consigned the mobilization of Mobile Task Force Beta-14 ("Hear No Evil")A task force utilized in environments where silence is imperative or that precludes the use of audio communication. to complete a thorough investigation of the second basement level, which exceeded decibel levels sufficient to result in permanent hearing loss. The following is a transcription from video recording devices.*
...
*The force continues towards the north wall, members each taking separate aisles of shelves. As with previous attempts, efforts to locate a possible source are unremarkable.*
...
*The following describes a series of tests in which texts, including the documents retrieved from B1 and B2, were situated in an anechoic chamber,A room engineered to totally assimilate sounds, achieving unnaturally quiet conditions. and the environment analyzed by both an array of high-sensitivity, directional microphones, and a Foundation operative. The operative placed in the anechoic chamber was the same across all trials, and had passed several medical and auditory sensitivity tests.E.g. tests for air conduction of sound waves, bone conduction of sound waves, and for low-grade tinnitus. The operative was asked to hold his breath and remain still during recordings.*
...
**Design:** As many texts as can fit in the chamber are supplied by sources other than the Library of CongressSources include texts from local libraries, book stores, and Foundation personnel private collections. and situated in the chamber with the individual. Sample is refined to include texts written by authors who are living.

**Result:** No additional frequencies reported by individual. No additional frequencies recorded by microphone array.

**Test #:** 03,,b,,

**Design:** Texts supplied by same sources in 03,,a,, are situated in the chamber with the individual. Sample is refined to include the same concentration of texts, but includes only those written by authors who are no longer living.
...
<details>
<summary>   b. Follow-Up Correspondence: Show File</summary>
...
<< [SCP-4057](SCP-4057) | SCP-4058 | [SCP-4059](SCP-4059) >>
...
> **Source Link:** [Flickr](https://www.flickr.com/photos/jiuguangw/7422071226)
