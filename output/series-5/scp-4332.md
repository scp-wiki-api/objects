...
Thank to users , , and  for looking at this.
...
SCP-4332 can be milked similarly to a non-anomalous cow. However, rather than providing milk, "milking" SCP-4332 will result in a stream of chunks of steak. The chunks will typically range from one to twenty cubic centimetres in size.  Each "milking" of SCP-4332 will produce roughly the same amount of meat as could be acquired from a non-anomalous member of its species.
...
<< [SCP-4331](SCP-4331) | SCP-4332 | [SCP-4333](SCP-4333) >>
