...
* With respect to Sub-project Savescum, the principal objective of uploading a stored human consciousness to a human body has not yet been successfully attained but the Project Director indicates a number of promising leads.  The Project Director reiterates a strong motivation to fulfill this stage of the project.SCP-4436 explains that in its current state, it is not practicable to observe the letter of the monastic rule, since Franciscan tunics, hoods and scapulars are not fitted to costume an exaflop Cray supercomputer.  Additionally, to quote SCP-4436 directly: "after seven hundred years, I'd really like to taste a beer again."  In the meantime, the existing practice of uploading stored human souls to appropriate alternative hardware will continue.
...
<< [SCP-4435](SCP-4435) | SCP-4436 | [SCP-4437](SCP-4437) >>
