...
Any text produced by SCP-4442 is printed as matte blackSCP-4442 will not change the color of its text, even if the vehicle in question is black.  576-point Impact font directly on the outer body of the vehicle. Testing has shown that the severity of the vandalism is proportionate to the severity of the moving violation; additionally, statements manifested are personalized to the driver.How SCP-4442 sources this personal information is currently unknown. For details, see addenda.

<details>
<summary>+ Addendum I: Testing Log 3</summary>
...
> || Brake-checking || "How's My Driving? Call ███-███-████!" D-10959's mother's home phone number.||Written across the back paneling.||  5 Seconds ||
...
<details>
<summary>+ Addendum II: Testing Log 8</summary>
...
> || Speeding (35MPH above posted limit) || "Speeding didn't kill my girlfriend. I did." D-80994 was initially incarcerated for Vehicular Homicide.   || Written along both right and left sides of the vehicle. || 15 Seconds ||

</details>

<details>
<summary>+ Addendum III: Testing Log ███ </summary>
...
> **Subject:** C-51174 Agent C. Trauss
...
> || Passing on the right Florida officially recognized passing on the right as a moving violation in 1999.  || "I'm not perfect, okay?"|| written across the hood || 10 MinutesSCP-4442 had not originally detected this as a moving violation; Agent Trauss was noted as standing in the middle of the intersection and speaking aloud, with SCP-4442's replies appearing in a smaller font alongside the passenger side door.  ||
...
<details>
<summary>+ Security Clearance Level 3 Required </summary>
