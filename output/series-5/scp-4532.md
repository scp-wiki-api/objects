...
**Description:** SCP-4532 is a high-frequency, high-entropy AM signal, broadcast on a low-amplitude carrier of roughly 3 THz. The ultra-high frequency of SCP-4532, coupled with a very low modulation index, renders SCP-4532 difficult to detect without extremely precise instruments. SCP-4532 has been exclusively observed to piggyback on manmade electromagnetic communications channels, including radio waves, telephone lines, and broadband internet over copper wiring.  These signals are the substance of a sapient distributed intelligence, which consists of a rapidly fluctuating number of sub-instances and copies that merge and divide throughout Internet and radio communications channels.
