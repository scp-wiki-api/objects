...
|caption=SCP-4740 *Hover to enlarge*‏‏‎‏‏‎ ‎
...
* Unknown grass species similar to *Hordeum vulgare* (barley)Inedible due to large amounts of potassium chloride.
...
It’s *everywhere*, no need to check!
...
The grass will shy into this world.If there is no current SCP-4740-1 instance, this line will read, *I'll guide the grass into this world.*
...
**Addendum 2:** The following is the most informative interviews with SCP-4740-1. To overcome SCP-4740-1's limited vocal capabilities, the instance used chlorophyll secreted from a non-terreneNot known to exist on earth. grass species within its major extremities to write responses to questions on paper provided to it.

<details>
<summary>+ Show Interview 4740-3</summary>
...
*(SCP-4740-1 emits a high pitched vocalisation for four minutes, ceasing when Agent Neil turns on his hand-held mower.)*
...
**Dr. Siobhan:** How were you able to produce *Panicum redundituus*? Has SCP-4740 been to SCP-███?
...
*A Foundation siren rings as the system picks up the memetic hazard. Both the observation room and the containment area fall into lock down.*
...
<< [SCP-4739](SCP-4739) | SCP-4740 | [SCP-4741](SCP-4741) >>
