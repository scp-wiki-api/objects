...
**Description:** SCP-4762 is an extradimensional program that spontaneously generates itself on computers operated by prominent members of the field of cosmology.The scientific study of the origin, evolution, and eventual fate of the universe. Notably, SCP-4762 has yet to target someone with the same preference in solution to Fermi's ParadoxA contradiction noted between the millions of years an alien civilization would have to fill the universe with evidence of its existence and an apparent lack of any evidence. as a previous target. The program will automatically run upon manifestation and overwrite any attached non-volatile data storage mediums with itself. Once completed, SCP-4762 will display two 4 by 4 Rubik's cubes surrounding a graphic of a person under two question marks. The left cube has yet to repeat an arrangement between manifestations while the right is always in a "solved" state. Any typed user input on the device SCP-4762 is running on will activate the anomaly's primary effect.
...
<< [SCP-4761](SCP-4761) | SCP-4762 | [SCP-4763](SCP-4763) >>
