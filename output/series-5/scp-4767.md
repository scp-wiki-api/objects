...
* Prove P=NP (SHOW YOUR WORK). P vs NP is an unsolved computational-complexity problem; if P=NP as this question implies, the majority of modern computer security is useless.

* Analyze the main themes and character motivations in Act II of William Shakespeare's *Cardenio*. Cardenio is a lost play and it is unclear if it was written by Shakespeare or written at all.

* What is the identity and purpose of dark matter?  Who created it? Dark matter is a hypothetical construct that explains certain aspects of stellar physics.  While Danish astronomer Jacobus Kapteyn was the first to propose its existence, it is not known if this question implies that dark matter itself actually has a creator. 

* Why does entropy increase over time?  Under what conditions does entropy reset? Entropy is the measure of order in any given system, and inevitably tends towards becoming more chaotic (higher) over time.  No known mechanism exists by which it could reset and it is unknown what would happen if this did occur.
...
> **Sandoval**: I don't know. This is an unsolved problem in human biology.
...
<< [SCP-4766](SCP-4766) | SCP-4767 | [SCP-4768](SCP-4768) >>
