@import url('https://fonts.bunny.net/css?family=Architects+Daughter&display=swap');
...
**Special Containment Procedures:** Outbreaks of SCP-4965 are detected using a pattern recognition AI, 'Dymphna', which has been distributed to most major world governments using Director Blackwood's connections in the *Parlement de la Sécurité Internationale* The Parliament of International Security.. The Foundation has also updated the words and phrases it monitors in global news channels to include descriptions of SCP-4965's effects.
...
|url=https://scp-wiki.wikidot.com/local--files/scp-4965/Zak3qMk.jpeg

|add-caption=true

|caption=A still taken from a video feed of an SCP-4965-1 at site T-4965-██ frozen in an unusual position.
...
<< [SCP-4964](SCP-4964) | SCP-4965 | [SCP-4966](SCP-4966) >>
