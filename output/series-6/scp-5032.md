...
SCP-5032-1 allows for the writing, compilation and execution of code compatible with an Atari Panther. While no explicitly anomalous technological components exist, the "Panther" object processor chip and the Motorola 68000 microprocessor are both embossed with symbols found in the Dresden Codex, pertaining to the "Jaguar God of Terrestrial Fire and War 'Night Sun'"A little-known Mayan jaguar deity, whose true name is unknown, taking the form of the sun during is journey into the underworld at night.  and "God L" Another Mayan jaguar deity, who is connected to commerce, magic, and battle., respectively, while the "Otis" sound processor has the number 32 embossed on it in Mayan numerals. These alterations are speculated to be the reason SCP-5032-1 can safely run anomalous programs.

Hard-coded into SCP-5032-1 are three demos, 'The Antelope Demo", "Prioritize Test #1"Meant to showcase the sprite-handling and sprite-scaling capabilities of the console, respectively, and "Processor". Publicly, the Processor demo was meant to demonstrate the color and sound-rendering capabilities of the Atari Panther, displaying a landscape of psychedelic colors and imagery, accompanied by an uneven acoustic soundscape.

While the Processor demo is running, SCP-5032-1 is able to compile and execute programs written in ICRDTA"Incremental Code Routed Directly Through Arrays", a custom-built programming language that allows for the creation and execution of thaumaturgical computer programs.. To date, SCP-5032-1 is the only known console capable of running games made using ICRDTA safely; attempting to run ICRDTA code on non-anomalous devices results in thaumic backlash, resulting in destruction of electronic components, or injury to any organic users.

---

SCP-5032-2 is a prototype for an anomalous controller modeled after the Atari MindlinkAn unreleased peripheral for the Atari 2600, allowing users to control games using 'myoneural signal voltage' transmitted via a headband. Despite recovered marketing materials, only one instance of an Atari Mindlink controller has been found to be anomalous., referred to in materials related to the Atari Panther as the "Atari BlankXSlate"Intended to be read as "Blank-Cross-Slate". SCP-5032-2 is worn around the head, and is intended to connect to the console via an infra-red receiver; however, a component cable that allows connection to an Atari Panther controller also exists.
...
> I know you probably can't respond to me. You've come up here fifty-nine timesAt this point in containment, the fight with Xbalanque had been reached a total of fifty-four times. with a different spouse, different parts, all sorts of different things. I didn't even kill your mother~~ the script says I did, but it's like a~~ not a ritual, what's the word. A play. Didn't have many of those in my day.
...
<< [SCP-5031](SCP-5031) | SCP-5032 | [SCP-5033](SCP-5033) >>
