...
|page=scp-5375[!~~ url of your page on the scp wiki ~~]
...
@import url('https://fonts.bunny.net/css?family=Pangolin&display=swap');

:root {

~~logo-image:url("https://smlt.wdfiles.com/local~~files/plaguebearer%3Anobody/%3F");

--header-title: 'NOBODY';

--header-subtitle: '...';

    --rating-module-text-color: 252,252,252;

    --rating-module-button-color:252,252,252;
...
.nameone {-webkit-filter: blur(1px);

filter: blur(1px);

}

.nametwo {-webkit-filter: blur(2px);
...
.scale, .level-text, .obj-text, .class-text, .itemnum {
...
    url('https://media.discordapp.net/attachments/524295654638354443/758773059577708604/Untitled_gradient.png');
...
    ~~woedbar-lvl1-color: rgba(var(~~swatch-menubg-light-color,12, 12, 12),0.1);

    ~~woedbar-lvl2-color: rgba(var(~~swatch-menubg-light-color,12, 12, 12),0.3);

    ~~woedbar-lvl3-color: rgba(var(~~swatch-menubg-light-color,12, 12, 12),0.55);

    ~~woedbar-lvl4-color: rgba(var(~~swatch-menubg-light-color,12, 12, 12),0.75);

}

---

[!~~ https://cdn.discordapp.com/attachments/534170796411715585/754538886197411951/pikrepo_2.jpg ~~]
...
**SCP-5353:** *Ah.* That explains that. Tyler's son, taking up the old family mantle?
...
**MALIZ:** I know the history. You've been hunting Nobody since World War I - *a hundred and fifty years.* What changed, I wonder - why are you now willing to cover for it?

**SCP-5353:** I haven't exactly been hunting Nobody though, have I? 

**MALIZ:** Yeah? Then what were you doing when you met my grandmother and my uncle?
...
**SCP-5353:** The consumption isn't instantaneous. It takes a while for it to shear through what makes you *you.* And I'm getting the sense that... you were right.
...
**SCP-5353:** It's the same damn Nobody every time. But the host matters just as much. 
...
**SCP-5353:** It's a war across centuries. But not once, in any of those centuries, has anyone - *anyone* - offered me what this one is offering me. 
...
**NOBODY:** Wait, you're- oh, Jesus. *Come on!*
...
**17:45:** Breach alarm set off at Mass Containment Site Beta. Two intruders reported.
...
[Nobody, Nobody, Nobody, and Nobody's Encounters

with The Man in the White Suit](https://scp-wiki.wikidot.com/nobodyx4)
...
<< [SCP-5374](SCP-5374) | SCP-5375 | [SCP-5376](SCP-5376) >>
...
> **Name:** GSI, Darmstadt, Juli 2015 (31).JPG

> **Author:** Alexander Blecher, [blecher.info](http://blecher.info/)

> **License:** CC BY SA 3.0 Germany

> **Source Link:** https://commons.wikimedia.org/wiki/File:GSI,_Darmstadt,_Juli_2015_(31).JPG

=====

> **Filename:** explosion.jpg

> **Name:** East Harlem apartment explosion aerial view.jpg

> **Author:** Adnan Islam, [@orangeadnan](https://twitter.com/orangeadnan)

> **License:** CC BY 2.0

> **Source Link:** https://commons.wikimedia.org/wiki/File:East_Harlem_apartment_explosion_aerial_view.jpg
