...
|url=http://scp-wiki.wdfiles.com/local--files/scp-5553/jackemail.png

|add-caption=true

|caption=An invitation email to join SCP-5553.
...
<details>
<summary>Addenda 5553.1: Site Content</summary>
...
According to the site's "about" page, it was launched in 1999 by an entity under the pseudonym Moriarity. Reviews of ICANNThe Internet Corporation for Assigned Names and Numbers records have produced no evidence of such a domain being registered, as .███ is not a valid top-level domain. An attempt to force ICANN to create the .███ domain for Foundation use is in progress.
...
<details>
<summary>Addenda 5553.2: Testing</summary>
...
*D-7372 is provided a laptop with restricted internet access, and is seated across a desk from Dr. Holt, a Foundation researcher. D-7372 is instructed to read through various items on his news feed. A short excerpt is included below.*
...
##white|OO##**Moriarity** Replied:

##white|OO##Yes. **+ - Score: +54**

---

**Rutherford_Hates** Updated his **Showcase** with a new entry. **+ - Score: +51**

*Information is recovered from the profile of user Adam Kepernickel and referred to external affairs; subject was apprehended by local law enforcement during an attempted murder.*

## Testing log 2: Posting to the News Feed

*D-7372 is instructed to make a innocuous post on the forum and report back the replies after an hour.*
...
##white|OO##**Kazimir** Replied:

##white|OO##More paintings. Know you're not alone in your cell, brother. **+ - Score: +1**

@@ @@

##white|OO##**APerfectCure** Replied:

##white|OO##Bravo! Good to have you back with us. **+ - Score: +3**

@@ @@

##white|OO##**Havok MacBrae** Replied:

##white|OO##Oooh. got caught. Not good, bro. Sucks to be you.**+ - Score: -3**

@@ @@

##white|OO##**Moriarity** Replied:

##white|OO##How are things on the inside? **+ - Score: +2**

*Test is concluded.*

## Testing log 3: Moriarity

*D-7372 receives a private message from Moriarity. D-7372 states he has never spoken to Moriarity before. D-7372 is authorized to interact with Morarity and respond as instructed, while relaying the responses. The conversation as reported by D-7372 is as follows:*
...
*According to D-7372, Moriarity does not respond for about 20 minutes. Test is concluded.*

</details>

<details>
<summary>Addenda 5553.3: Incident 5553-A</summary>
...
<details>
<summary>Addenda 5553.4: Personnel Request</summary>
...
<details>
<summary>Addenda 5553.5: Incident 5553-A, Continued</summary>
...
*At this point, Moriarity spent fifteen minutes explaining an intricate plan of escape utilizing classified documents and schematics, until the test ended.*

*At the time of this writing, PSM-1 users report that D-7372's account is again actively posting.*

</details>

<details>
<summary>Addenda 5553.6: Brief Conversation with Moriarity</summary>
...
##white|OO##Ah, tough luck there, chum. **+ - Score: +1**

@@ @@

##white|OO##**Goldfather** Replied:

##white|OO##Hey **@Moriarity**, why does it kill people sometimes? Isn't the confusion enough?. **+ - Score: +1**

@@ @@

##white|OO##**Moriarity** Replied:

##white|OO##**@Goldfather** **@@https://jack.███@@/Moriarity/Showcase** **+ - Score: +13**

</details>

<< [SCP-5552](SCP-5552) | SCP-5553 | [SCP-5554](SCP-5554) >>

=====

> **Name:** jackemail.png and jacklogo.png
