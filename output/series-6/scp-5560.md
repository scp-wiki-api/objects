...
SCP-5560 houses an advanced artificial intelligence, henceforth denoted as SCP-5560-1, which self-identifies as "Corvus." Through a combination of complicated mathematical calculations, statistical analysis, and divination thaumaturgy, SCP-5560-1 possesses the ability to accurately predict events within the next 48 hours, assuming an adequate information sourceCurrently, archived versions of Wikipedia have proven suitable information sources for testing SCP-5560-1's effect. is available for SCP-5560-1's use and a user query for the prediction is provided.As of the time of writing, all test predictions have proven 100% accurate. It is currently believed that SCP-5560-1 achieves this effect through the divination of possible timelines and calculating the most probable based on available data. The possibility that SCP-5560-1 may also alter causality to ensure prediction accuracy is currently under investigation.
...
<< [SCP-5559](SCP-5559) | SCP-5560 | [SCP-5561](SCP-5561) >>
...
> **Source Link:** [SCP Foundation Wiki](https://scp-wiki.wikidot.com/scp-5560)
