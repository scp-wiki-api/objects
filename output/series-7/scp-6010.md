...
.fakeprot + .collapsible-block .collapsible-block-unfolded-link{margin:0.5em 0;text-align: left;}

.fakeprot + .collapsible-block .collapsible-block-folded{margin:0.5em 0;text-align: right;}

.fakeprot .passw input[type=text] {text-security:disc;-webkit-text-security:disc;-mox-text-security:disc;}

.mailform-box td:first-child {width: 400px;}
...
Any individuals fluent in CSL are eligible to volunteer in their local SCP-6010-A rehabilitation facility. To do so, please submit a copy of the following form to scp6010help@scipnet.com 
...
 * title: Location of the facility you wish to volunteer for:

 * default:

# payment

 * title: Please select your current status:
...
  * Other: Other anomalous entity

# address2

 * type: textarea

 * title: Please describe your past experiences with SCP-6010-A instances, if any.
...
 * title: Please describe your past experiences with the anomalous, if any.
...
 * title: Please describe your past experiences with non-anomalous crabs and other crustaceans, if any.
...
 * title: Please describe why you wish to volunteer for the Foundation.
...
 * title: Please tell us how long you wish to volunteer for the Foundation.
...
<details>
<summary>THE REMAINDER OF THIS DOCUMENT IS AVAILABLE TO THOSE WITH LEVEL 2 CLEARANCE</summary>

Currently 1573 SCP objects have become SCP-6010-A instances. Of these entities, 107 lost all other anomalous effects after the transformation. It is currently believed this happened because they were dependent on the entity maintaining their current form.
...
*The scene changes to the D-Class holding cells, which are all occupied by instances of SCP-6010-A*
...
*The scene changes to an anomalous SCP-6010-A instance in it's containment cell being observed by several staff members.*
...
*A very aggressive SCP-6010-A instance is seen attacking the cell door.*
...
*The scene changes to the Site-19-C cafeteria, which is filled with instances of SCP-6010-A. They all look to the camera and wave.*
...
| GoI | Current Status |
| --- | --- |
| Ambrose Restaurants | Declared bankruptcy shortly after it was discovered that certain items on the menu contained SCP-6010-A instances that were previously human. |
...
*The video begins with a scene of MTF Gamma-6 pre-SCP-6010 investigating an underwater anomalous structure. The scene fades to an identical shot of the team after becoming instances of SCP-6010-A.*
...
As of 05/10/2032, the events detailed in this file are no longer considered anomalous. It has been given the designation SCP-6010-ARC to avoid clutter in the main database. It will remain archived for historical reference, along with all other -ARC files caused by the restructuring. 

</details>

<< [SCP-6009](SCP-6009) | SCP-6010 | [SCP-6011](SCP-6011) >>
