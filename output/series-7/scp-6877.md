...
    --header-title: "Site-44";

    --header-subtitle: "VERDANT ARCHIVES";

    ~~logo-image: url("http://scp-sandbox-3.wikidot.com/local~~files/ozzylizard-2/Site-44Plain2.png");
...
**Events and Observations:** D-8986 is outfitted with similar equipment to former tests in addition to a barometer  A device that is used to measure air pressure.  and binary gas analyser  Used to determine the ratio of gases in an environment.  in order to carry out an atmospheric survey within SCP-6877-1. D-8986 is told to ascend SCP-6877 for as long as physically possible and report any significant events or findings.
...
<< [SCP-6876](SCP-6876) | SCP-6877 | [SCP-6878](SCP-6878) >>

> **Filename:** VerdantHeights

> **Author:** 

> **License:** CC BY-SA 3.0

> **Source Link:** [SCP Foundation Wiki](https://scp-wiki.wikidot.com/scp-6877)

> **Filename:** VerdantPeak
