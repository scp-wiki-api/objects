...
/*@import url('http://scp-sandbox-3.wikidot.com/local--files/croquemtest/TT2020StyleB.css');

@import url('http://scp-sandbox-3.wikidot.com/local--files/croquemtest/TT2020StyleD.css');

@import url('http://scp-sandbox-3.wikidot.com/local--files/croquemtest/TT2020StyleE.css');

@import url('http://scp-sandbox-3.wikidot.com/local--files/croquemtest/TT2020StyleG.css');*/
...
  background-image: url(http://scp-sandbox-3.wikidot.com/local--files/collab:letters/paper-texture.webp);
...
  font-family: 'TT2020 Style B', 'Special Elite', monospace;
...
  font-family: 'TT2020 Style D (ASCII)', 'Special Elite', monospace;
...
  font-family: 'TT2020 Style E', 'Special Elite', monospace;
...
  font-family: 'TT2020 Style G (ASCII)', 'Special Elite', monospace;
...
Hermann's body had been fully covered in growths of *Kindbergia Oregana* "Oregon Beaked Moss"  and numerous unidentified root growths across his skin and internal organs. After approximately 18-hours of contiguous surgery, it was deemed infeasible to remove all of the growths at the time with the given resources. As such, primary surgical efforts were focused on the removal of growths concentrated around Hermann's eyes, nostrils, ear canals, and throat. After a further 7-hours of surgery, minor progress was made at which point Hermann was transferred to Site-56 for a further surgery to be hypothesized and implemented, along with interviewing Hermann as to the origin of the anomaly that occurred in his physical person.
...
**Kanley:** No. A search is currently underway. A tactic utilized to not introduce unreliable, emotional complications to Hermann's testimony. 
...
<< [SCP-7184](SCP-7184) | SCP-7185 | [SCP-7186](SCP-7186) >>

=====

> **Filename:** Shaping Machine _ An odd item to find in the RAF Museum but … _ Flickr

> **Name:** 4607429834_8ec3f786de_b.jpeg

> **Author:** Leslie Chatfield

> **License:** CC BY-SA 2.0

> **Source Link:** [Openverse](https://openverse.org/image/108fe831-8c8c-44b3-837b-0794c308147d?q=shaping%20machine)
