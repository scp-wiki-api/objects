.content-panel-standalone > blockquote {background-color: #fff;}

.rotate > blockquote {background-color: #fff;}

.rotate2 > blockquote {background-color: #fff;}

.rotate3 > blockquote {background-color: #fff;}

.rotate4 > blockquote {background-color: #fff;}

.rotate5 > blockquote {background-color: #fff;}

.rotate6 > blockquote {background-color: #fff;}

.rotate7 > blockquote {background-color: #fff;}

.rotate8 > blockquote {background-color: #fff;}
...
*Nervously, cautiously, he follows the {{gnarled}} and {{cr^^oo^^k,,e,,d shape}} as it bends down, down. Flight after flight after flight. Ever deeper. Never ending. You know it never ended. Never finished.*
...
> The sky comes into view as Dr. Lafayette emerges in the anomalous facsimile of Temby. There are no stars, but the moon is full.It was not a full moon in baseline reality on the night the incident took place, but a full moon *was* present on the night SCP-783's most recent manifestation began. Long cylindrical objects extend from the ground and stretch high into the air, seemingly without end, waving slightly in the wind. Human mouths can be seen on several of the protrusions. Dr. Lafayette begins walking toward the treeline and the sound of moaning grows softer.
...
<< [SCP-7426](SCP-7426) | SCP-7427 | [SCP-7428](SCP-7428) >>

=====

> **Filename:** datalost.png
...
> **Source Link:** [Pixabay](https://pixabay.com/moon-moonlight-night-sky-winter-722052)

> ----

> **Name:** Two-oh-six three-sixty-five (5391425836).jpg

> **Author:** Laura LaRose

> **License:** CC-BY-SA 2.0

> **Source Link:** [Wikimedia Commons](https://commons.wikipedia.org/wiki/file:two-oh-six_three-sixty-five_(5391425836).jpg)
