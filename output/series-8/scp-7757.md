...
Per the stipulations of the SM4 Pact of 2015, the Department of Surrealistics has requested the aid of the Foundation in suppression of an ongoing containment situation apparently related to SCP-7757. A body known as the SCRCSurrealistics Containment Reform Committee. is to be created for this purpose, which is to implement all primary containment operations for the object and also enact broader reforms on Site-⌘ as a whole. These policies are as follows: 
...
* He was Site-⌘'s director of Intangible Anomalous Applications (IAA);Position vacant--we are hiring!*Unauthorized*. -B. Randall.
...
**Gat:** I thought this was a serious interview.The joking days for this month are Mondays, Tuesdays, and Fridays.*Unauthorized*. -B. Randall.
...
<< [SCP-7756](SCP-7756) | SCP-7757 | [SCP-7758](SCP-7758) >>
...
    ~~logo: url('https://scp-wiki.wdfiles.com/local~~files/scp-6445/Surrealistics%20Logo.png');
...
div.surrealconprocs_memo {

    --memo-heading: "**_****_****_****_****_****_****_****_****_****_****_****_****_****_****_****_****_****_****_**_";

    ~~memo-logo: url(https://scp-wiki.wdfiles.com/local~~files/taboo/Museo.cs);

    --memo-color: 232, 252, 252;

}

div.surrealdescription_memo {
...
div.realconprocs_memo {

    --memo-heading: "**_****_****_****_****_****_****_****_****_****_****_****_****_****_****_****_****_****_****_**_";

    --memo-logo: url(https://lounge.hexick.com/uploads/0a423dea78e5984d/image.png style="width: 150px);

    --memo-color: 209, 199, 201;

}

div.realdescription_memo {
...
    border-left: solid 4px rgb(85, 83, 82);

    border-right: solid 4px rgb(85, 83, 82);

    border-top: solid 4px rgb(85, 83, 82);

    border-bottom: solid 4px rgb(85, 83, 82);
