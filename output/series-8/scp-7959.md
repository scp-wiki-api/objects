...
--selection-background-color: 197, 119, 41;

~~link-color: var(~~basalt-alternate-color);

~~link-visited-color: var(~~basalt-alternate-color);
...
    background-image:url("https://scpdsandbox.wdfiles.com/local--files/billith/web.png");
...
![](https:*scp-wiki.wdfiles.com/local--files/scp-6768/deletion.png)
...
> POI-7959: Regrettably, I must inform you that the Prime Timeline is closed.It should be noted that no known initial or "prime" timeline exists, though this false claim is common among narratives in many regions of memoryspace. Please return during normal hours, where we will be more than happy to assist you. If you require immediate assistance, please leave a message after the tone, and someone will be with you shortly.   
...
> AUTOMATED SYSTEM: *This mailbox is full and cannot receive more messages. I'm sorry. Goodbye.*

>

> = {{<END TRANSCRIPT>}}

<< [SCP-7958](SCP-7958) | SCP-7959 | [SCP-7960](SCP-7960) >>

]

> **Filename:** web.png

> **Name:** Patterns in Desert Plants

> **Author:** Alex Grande

> **License:** CC-BY 2.0

> **Source Link:** [flickr](https://www.flickr.com/photos/7106641@N05/5219914594)
